...
class Background():
    def __init__(self, game, player):
        ...
        stage_2 = Stage(game, *self.main_image.get_rect().size, image_source="resources/images/mv_bg2.png",
                        slowing_rate=3)
...
class Stage():
    ...
    def draw(self):
        ...
        relative_position.x - self.background_width, relative_position.y - self.background_height))
